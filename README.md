...
>### Module 13 UNC Coding Bootcamp Challenge - E-commerce Back End <br><br>
...
```sh
git clone git@github.com:t-starkw/retail-therapy.git
```
...
1. Fork it (<https://github.com/t-starkw/retail-therapy/fork>)
